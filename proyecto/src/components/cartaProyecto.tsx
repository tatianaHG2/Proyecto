...
function CardDetail({
    ...
    return (
        <div className={`bg-black border-2 border-red-600 rounded-2xl p-6 w-72 cursor-pointer relative ${className}`} onClick={() => onOpen && onOpen()}>
            {Rareza && (
            ...
            <div className="flex justify-between text-sm">
                ...
                <span className="bg-blue-600 text-white px-3 py-2 rounded-full font-semibold shadow-sm">Defensa: {Defensa}</span>
            </div>
        </div>
    );
}
